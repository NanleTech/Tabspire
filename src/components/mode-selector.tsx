...
const MODES: ModeOption[] = [
  {
    ...
    features: ["Bible verse", "Devotional", "Mood check-in", "Faith goals", "Kokoro TTS", "Guided meditation", "Verse journal"],
  },
  {
    id: "work",
    name: "Work",
    ...
    features: ["All Simple features", "Task planner", "Wisdom chips", "Integrity nudge", "Rest reminder", "Work anchor verse", "EOD reflection"],
  },
  {
    id: "full",
    name: "Full",
    ...
    features: ["All Work features", "Goal dashboard", "KPI tracking", "Weekly AI insights", "Goal-verse integration", "Advanced analytics"],
  },
];
